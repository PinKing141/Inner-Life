...
const Icons = (() => {
  ...
  const lib = {
    ...
    infant: wrap(`<circle cx="12" cy="5" r="2.5"/><ellipse cx="12" cy="10.5" rx="6" ry="2.6"/><circle cx="12" cy="17" r="4"/>`),
    school: wrap(`<circle cx="8" cy="8" r="2.5"/><path d="M3.5 19c0-3 2-4.5 4.5-4.5s4.5 1.5 4.5 4.5"/><circle cx="16" cy="8" r="2.5"/><path d="M11.5 19c0-3 2-4.5 4.5-4.5s4.5 1.5 4.5 4.5"/>`),
