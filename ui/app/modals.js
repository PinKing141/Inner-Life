      ...
      blocks: [
        ...
        ...(r.alive ? [
          ...
          { type: "list", items: [
            ...
            { icon: "moon", accent: "var(--c-smarts)", title: "Heart-to-heart",
              subtitle: "Bigger emotional swing — sometimes lands, sometimes drains",
              trailing: { kind: "chevron" }, action: "rel-interact",
              payload: { npc_id: npcId, action: "deep_talk" } },
          ...
          { type: "list", items: [
            { icon: "gem", accent: "var(--gold)", title: "Give a gift",
              subtitle: "Costs £50",
              trailing: { kind: "chevron" }, action: "rel-interact",
              payload: { npc_id: npcId, action: "gift" } },
            { icon: "gem", accent: "var(--gold)", title: "Lavish gift",
              subtitle: "Costs £500",
              trailing: { kind: "chevron" }, action: "rel-interact",
              payload: { npc_id: npcId, action: "lavish_gift" } },
            { icon: "happy", accent: "var(--c-happy)", title: "Take to dinner",
              subtitle: "Costs £80",
              trailing: { kind: "chevron" }, action: "rel-interact",
              payload: { npc_id: npcId, action: "take_to_dinner" } },
